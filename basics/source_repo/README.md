...
```
gsrName    = "my-repo"
gsrProject = var.gcp_project_id
```

## Example

View the [example configuration](https://github.com/CloudVLab/terraform-lab-foundation/tree/main/basics/source_repo/example) to get started.
