...
```
curl -L https://github.com/CloudVLab/terraform-lab-foundation/raw/main/basics/bq_dataset/example/install.sh | bash
```
...
```
 ...
 8    - label: BigQuery Dataset 
 9      reference: project_0.startup_script.bq_dataset_id
```
