...
module "la_gcf_mp" {
  ...
  gcf_archive_object   = var.function_1_zip 
  gcf_archive_source   = var.function_1_source
}
...
##   gcf_runtime          = "nodejs16"
##   gcf_archive_object   = var.function_2_zip 
##   gcf_archive_source   = var.function_2_source
